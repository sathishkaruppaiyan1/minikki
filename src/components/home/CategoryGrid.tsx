        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {categories.map((category, index) => (
            <Link
              ...
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <Reveal className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 h-full flex flex-col p-3">
                {/* Image */}
                ...
                <div className="pt-3 bg-white">
                  <h3 className="text-center font-bold text-base lg:text-lg text-black group-hover:text-primary transition-colors duration-300">
                    {category.name}
                  </h3>
                </div>
              </Reveal>
